...
export default function WorldMapPreview({ regions }: WorldMapPreviewProps) {
  ...
  return (
    ...
    >
          ...
          {tooltip && (
            <motion.div
              className="absolute pointer-events-none z-10 px-3 py-2 rounded-lg
                         bg-[#0c0c14]/95 border border-white/[0.08] backdrop-blur-sm
            ...
            >
              ...
              <div className="text-blue-400 mt-0.5">
                ...
                <span className="text-white/30">citizens</span>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      {/* ----- Legend ----- */}
      <div className="px-5 py-3 border-t border-white/[0.06] flex items-center gap-5">
